...
export const CARD_DELETE_SUCCESS_TO_FALSE = 'CARD_DELETE_SUCCESS_TO_FALSE';
...
export const clickOnButtonDeleteCard = (value) => ({
...
export const cardDeleteSuccessToFalse = () => ({ type: CARD_DELETE_SUCCESS_TO_FALSE });
